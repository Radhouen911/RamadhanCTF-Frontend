...
import { Trophy, Users, Flag, User, Bell, ChevronDown, Menu, X, Star } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          height: '2px',
          background: 'linear-gradient(90deg, transparent, rgba(212,165,32,0.6), rgba(192,132,252,0.4), transparent)',
        }}
      />
          ...
          <Link to="/" className="flex items-center gap-3">
            ...
            <div className="relative w-9 h-9 flex items-center justify-center">
              <svg width="36" height="36" viewBox="0 0 36 36">
                ...
                <circle cx="16" cy="18" r="12" fill="#fbbf24" filter="url(#logo-glow)" />
                <circle cx="21" cy="15" r="10" fill="#060b15" />
                <polygon
                  points="28,8 29.5,12.5 34,12.5 30.5,15.5 32,20 28,17 24,20 25.5,15.5 22,12.5 26.5,12.5"
                  fill="#fbbf24"
